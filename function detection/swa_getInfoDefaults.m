...
switch type
    ...
    case 'SS'
        ...
        % Spindle Criteria       
        Info.Parameters.Ref_AmplitudeCriteria = 'relative'; % relative/absolute
        Info.Parameters.Ref_AmplitudeMetric = 'median';  % mean / median
        Info.Parameters.Ref_AmplitudeRelative = [8, 5];  % deviations from mean [high, low]
        ...
        Info.Parameters.Ref_PowerGapMax = 0.15;     % Maximum gap between power above threshold (s)
